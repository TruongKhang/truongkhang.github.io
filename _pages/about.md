...
**Research interests:** Currently, I focus on some topics in 3D vision such as 3D reconstruction, multi-view stereo, or camera pose estimation. My goal is to produce algorithms which can achieve high performance using limited GPU resources. I made several programs on [Github](https://github.com/TruongKhang).
